...
Lab1::Lab1(GLFWWindowImpl& win) : Layer(win)
{
	...
	floorphongShaderDesc.type = ShaderType::rasterization;
	floorphongShaderDesc.vertexSrcPath = "./assets/shaders/floorVertShader.glsl";
	floorphongShaderDesc.fragmentSrcPath = "./assets/shaders/floorFragShader.glsl";
	//making a floor
	...
	//creating a cube shader
	ShaderDescription cubephongShaderDesc;
	cubephongShaderDesc.type = ShaderType::rasterization;
	cubephongShaderDesc.vertexSrcPath = "./assets/shaders/PhongVert.glsl";
	cubephongShaderDesc.fragmentSrcPath = "./assets/shaders/PhongFrag.glsl";
	//making a cube
	...
	//reading in the cube model with Assmip
	Model cubeModel("./assets/models/Vampire/vampire.obj", attributeTypes);
	...
	//creating the cube material
	
	std::shared_ptr<Texture> vampireDiffuse;
	vampireDiffuse = std::make_shared<Texture>("./assets/models/Vampire/textures/diffuse.png");
	...
	cubeMaterial->setValue("u_albedoMap", vampireDiffuse);
	cubeMaterial->setValue("u_specularMap", vampireSpecular);
	cubeMaterial->setValue("u_normalMap", vampireNormal);
	Actor cube;
	cube.geometry = cubeVAO;
	cube.material = cubeMaterial;
	cube.translation = glm::vec3(0.f, -5.f, -11.f);
	cube.scale = glm::vec3(5.f, 5.f, 5.f);
	cube.recalc();
	modelIdx = m_mainScene->m_actors.size();
	...
	skyboxphongShaderDesc.vertexSrcPath = "./assets/shaders/skyboxVert.glsl";
	skyboxphongShaderDesc.fragmentSrcPath = "./assets/shaders/skyboxFrag.glsl";
